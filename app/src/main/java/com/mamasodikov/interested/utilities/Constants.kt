package com.mamasodikov.interested.utilities
           ...
           fun getRemoteMessageHeaders():HashMap<String,String>{
                if(remoteMsgHeaders==null){
                     ...
                     remoteMsgHeaders!!.put(
                          ...
                          "key=AAAAGenangA:APA91bGlx-vqRGOAYVLUdwWSRhZocTKd5gfvnG_f95zZap_txBXueOfS8nma8clE7BQWouDs6FaW4C8SEo4FjAWMEOcvyJzHtBBl_2JhuEH7m54wLaf_eUTzYqiMCtPWeeHeIXYa1ze-"
                     )
                     remoteMsgHeaders!!.put(
